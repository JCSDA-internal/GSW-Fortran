...
$TAPENADE_HOME/bin/tapenade ${opts} -d -O tlm/ -head "gsw_pot_to_insitu.t_from_pt(t_from_pt pt_in sp_in)/(pt_in sp_in)" gsw_pot_to_insitu.f90 modules/*0 toolbox/*0
...
$TAPENADE_HOME/bin/tapenade ${opts} -b -O adm/ -head "gsw_pot_to_insitu.t_from_pt(t_from_pt pt_in sp_in)/(t_from_pt pt_in sp_in)" gsw_pot_to_insitu.f90 modules/*0
cd adm/
